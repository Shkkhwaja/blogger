  ...
  return (
    ...
    <div>
      <div class="flex items-start">
        ...
        <div id="sidebar-collapse-menu" style={{ height: 'calc(100vh - 72px)' }} className="bg-white shadow-lg h-screen fixed py-6 px-4 top-[70px] left-0 overflow-auto z-[99] lg:min-w-[250px] lg:w-max max-lg:w-0 max-lg:invisible transition-all duration-500">
            <ul class="space-y-2">
              <li>
                <a href="javascript:void(0)"
