...
const Footer = () => {
  return (
    <div>
      <footer class="font-sans tracking-wide bg-gray-600 py-10 px-12">
          ...
          <div class="col-span-full max-w-2xl">
            ...
            <form class="mb-4">
              <div class="flex items-center">
                ...
                <button
                  type="button"
                  class="bg-gray-700 text-[15px] text-gray-300 tracking-wide px-4 py-3.5 rounded-r-md"
                >
                  Subscribe
                </button>
              </div>
        ...
        <p class="text-gray-300 text-right text-[15px] mt-8">
